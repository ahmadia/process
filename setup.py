...
setup(name='process',
      ...
      data_files=[('examples',get_files('examples')),
                  ...
                  ('system/config/ppc64',['system/config/ppc64/kslinstall.ini','system/config/ppc64/kslrun.ini']),
                  ('system/config/x86_64',['system/config/x86_64/kslinstall.ini','system/config/x86_64/kslrun.ini']),
